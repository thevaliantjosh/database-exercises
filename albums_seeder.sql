...
INSERT INTO albums (artist, album_name, release_date, sales, genre) VALUES ('Michael Jackson', 'Thriller', 1982, 50.2, 'Pop, post-disco, funk, rock'),
('AC/DC', 'Back in Black', 1980, 30.1, 'Hard rock'),
('Whitey Houston', 'The Bodyguard', 1992, 28.7, 'R&B, soul, pop, soundtrack'),
...
('Fleetwood Mac', 'Rumours', 1997, 29.3, 'Soft rock'),
('Bee Gees', 'Saturday Night Fever', 1997, 22.1, 'Disco'),
