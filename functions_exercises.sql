...
SELECT CONCAT(first_name, ' ', last_name) AS 'Full Name', birth_date AS 'Christmas Birthdays', hire_date AS '90''s Hires', DATEDIFF(NOW(), hire_date) AS '# Of Days at Company' FROM employees
