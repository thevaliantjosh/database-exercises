...
SELECT COUNT(last_name) AS '# of Unique Last Names', last_name FROM employees WHERE last_name LIKE '%Q%' AND last_name NOT LIKE '%QU%' GROUP BY last_name ORDER BY COUNT(last_name)DESC;
